...
const Header = () => {
  ...
  return (
    <>
      <header
        // This is the fix for the navbar background from before
        className={`header left-0 top-0 z-40 flex w-full items-center transition-all duration-300 ${
          sticky
            ...
            : "relative bg-white dark:bg-dark shadow-md"
        }`}
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              <Link
                href="/"
                // POINT 3: Navbar height kam kar di
                className={`header-logo block w-full ${
                  sticky ? "py-3 lg:py-2" : "py-4"
                } `}
              >
                {/* POINT 1: Original logo wapas daal diya */}
  ...
  NIRMAAN
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                {/* POINT 2: Sign In aur Sign Up buttons wapas daal diye */}
                <Link
                  href="/signin"
