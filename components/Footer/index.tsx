        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  Nirmaan Club - Building Innovation at IIT Mandi. Empowering students through technology, creativity, and collaborative learning.
                </p>
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/nirmaaniitmandi/"
                    target="_blank"
                  ...
                  <a
                    href="https://www.instagram.com/nirmaan_iitmandi/"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://github.com/NirmaanClub/Nirmaan-2k22"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="GitHub"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  ...
                  <a
                    href="https://wiki.iitmandi.co.in/index.php/Main_Page"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Wiki"
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="mailto:nirmaan@iitmandi.ac.in"
                      className="dark:text-body-color-dark mb-4 inline-flex items-center text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                    >
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              © 2024 Nirmaan Club, IIT Mandi. All rights reserved.
            </p>
          </div>
        </div>
...
//               </Link>
//               <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
//                 Nirmaan Club - Building Innovation at IIT Mandi
//               </p>
...
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className="dark:text-body-color-dark mb-3 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
//                   >
//                     Wiki
//                   </a>
//                 </li>
...
//                   <a
//                     href="mailto:nirmaan@iitmandi.ac.in"
//                     className="dark:text-body-color-dark inline-flex items-center text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
//                   >
